...
// period.
const (
	// ApiServiceGreetProcedure is the fully-qualified name of the ApiService's Greet RPC.
	ApiServiceGreetProcedure = "/openvm.v1.ApiService/Greet"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	apiServiceServiceDescriptor     = v1.File_openvm_v1_api_proto.Services().ByName("ApiService")
	apiServiceGreetMethodDescriptor = apiServiceServiceDescriptor.Methods().ByName("Greet")
)
...
func NewApiServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ApiServiceClient {
	...
	return &apiServiceClient{
		greet: connect.NewClient[v1.GreetRequest, v1.GreetResponse](
			httpClient,
			baseURL+ApiServiceGreetProcedure,
			connect.WithSchema(apiServiceGreetMethodDescriptor),
...
// Greet calls openvm.v1.ApiService.Greet.
func (c *apiServiceClient) Greet(ctx context.Context, req *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error) {
...
func NewApiServiceHandler(svc ApiServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	apiServiceGreetHandler := connect.NewUnaryHandler(
		ApiServiceGreetProcedure,
		svc.Greet,
		connect.WithSchema(apiServiceGreetMethodDescriptor),
	...
	return "/openvm.v1.ApiService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case ApiServiceGreetProcedure:
			apiServiceGreetHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedApiServiceHandler) Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("openvm.v1.ApiService.Greet is not implemented"))
}
